 ...
 * <p>
 * Each level (DEBUG,INFO,WARN) has its own color that you can customize. To use this file, in your log4j.properties or
 * log4j.xml specify ANSIColorLayout instead of a PatternLayout.
 * <p>
 * <p>
 * <b>log4j.properties</b>
 * <p>
 * log4j.appender.A1.layout=org.osuosl.logging.ANSIColorLayout log4j.appender.A1.layout.ConversionPattern=%-5p
 * [%d{MM-dd-yyyy HH:mm:ss}] %c - %m%n
 * <p>
 * log4j.appender.A1.all=\u001B[1;37m log4j.appender.A1.fatal=\u001B[1;31m log4j.appender.A1.error=\u001B[0;31m
 * log4j.appender.A1.warn=\u001B[1;33m log4j.appender.A1.info=\u001B[0;37m log4j.appender.A1.debug=\u001B[0;36m
 * log4j.appender.A1.reset=\u001B[1;37m log4j.appender.A1.stacktrace=\u001B[0;31m log4j.appender.A1.defaultcolor=\u001B[1;37m
 *
 * @author peter Date: Nov 30, 2005 Time: 1:24:35 PM https://code.google.com/p/a-distributed-file-system/source/browse/trunk/DistributedFileSystem/ui/net/dfs/ui/ANSIColorLayout.java
 */
public class ANSIColorLayout extends PatternLayout {
    ...
    /**
     * defaultcolor - default terminal color.  this is the color that the terminal will be reset to after each line.
     * default is white
     */
